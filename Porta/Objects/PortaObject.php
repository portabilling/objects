...
class PortaObject implements \ArrayAccess
{
     ...
     */
    public function loadParent(DefInterface $def, int $options = 0, array $params
            = []): ?self
    {
     ...
     */
    public function loadChildren(DefInterface $def, int $options = 0, array $params
            = []): array
    {
    ...
    {
        return array_key_exists($offset, $this->updatedData) ? $this->updatedData[$offset]
